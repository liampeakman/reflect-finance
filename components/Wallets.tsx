        ...
        walletList.push(
            ...
            >
                <Stack direction='row' align='center'>
                    <Image src={`https://storage.googleapis.com/zapper-fi-assets/tokens/${networks[i].network}/0x0000000000000000000000000000000000000000.png`} w='30px'></Image>
                    <Text display={{base:'none', md:'unset' }} width={20} textTransform='capitalize' textAlign='left'>{networks[i].network}</Text>
                </Stack>
                ...
                variant='external' 
                padding={0} 
                href={"https://" + networks[i].scan + "/address/" + wallet} target='_blank'
                >
